...
public class PrintTicket1 extends JFrame
{
	public PrintTicket1(String sFrom, String sTo, String sClass, Integer iAdult, Integer iChildren, Integer iInfant, String sBookingDate, Integer iPrice, String sTime)
	{
		...
		JLabel LAnkitMaurya=new JLabel("<html><I><font color=\"#8FBC8F\">Ankit Maurya</font></I></html>");
		JLabel LGauravDhokane=new JLabel("<html><I><font color=\"#8FBC8F\">Gaurav Dhokane</font></I></html>");
		JLabel LVishalHarne=new JLabel("<html><I><font color=\"#8FBC8F\">Vishal Harne</font></I></html>");
		JLabel LOmkarJadhav=new JLabel("<html><I><font color=\"#8FBC8F\">Omkar Jadhav</font></I></html>");
		...
		LAnkitMaurya.setBounds(285,485,300,20);
		LGauravDhokane.setBounds(285,505,300,20);
		LVishalHarne.setBounds(285,525,300,20);
		LOmkarJadhav.setBounds(285,545,300,20);
		...
		Panel2.add(LAnkitMaurya);
		Panel2.add(LGauravDhokane);
		Panel2.add(LVishalHarne);
		Panel2.add(LOmkarJadhav);
